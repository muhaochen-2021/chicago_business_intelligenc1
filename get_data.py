...
api_key = "AIzaSyDmnz1QIpXCXvpKDZCnThp3hfE0qghByuo"
db_host = "/cloudsql/chicago-business-intelligenc1:us-central1:mypostgres1"
...
db_connection.commit()
# get the data
url = "https://data.cityofchicago.org/resource/m6dm-c72p.json?$query=select%20*%2C%20%3Aid%20order%20by%20%60trip_start_timestamp%60%20desc%20limit%200300"
print("try to connect")
# requests
r = requests.get(url)
# get json
...
url = "https://data.cityofchicago.org/api/id/building-permits.json?$query=select%20*%2C%20%3Aid%20order%20by%20%60issue_date%60%20desc%20limit%200300"
print("try to connect")
# requests
